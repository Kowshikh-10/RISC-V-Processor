...
![Sequential Datapath](https://github.com/Kowshikh-10/RISC-V-Processor/blob/main/Sequential_Datapath.png)

This is a basic RISC-V (32-bit instruction set) processor, supporting the instructions `add`, `sub`, `and`, `or`, `beq`, `addi`, `ld`, `sd` (might add support for more in the future :p) implemented in iVerilog, as part of the course project for the Spring 2026 course "Introduction to Processor Architecture" at IIIT Hyderabad. The components in the sequential processor are mentioned below.

Team Members - R.KRS Kowshikh Reddy , G.Nischal , B.V.Shashank
...
![ALUControl truth table](https://github.com/Kowshikh-10/RISC-V-Processor/blob/main/ALUControl_truth_table.png)
...
![Pipelined Processor](https://github.com/Kowshikh-10/RISC-V-Processor/blob/main/PipelinedProcessor.png)
